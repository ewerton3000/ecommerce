            ...
            <div class="col-md-6">
                ...
                <form id="register-form-wrap" action="/register" class="register" method="post">
                    ...
                    <p class="form-row form-row-first">
                        ...
                        <input type="text" id="phone" name="phone" class="input-text" placeholder="Telefone não é obrigatório"value="<?php echo htmlspecialchars( $registerValues["phone"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                    </p>
                    <p class="form-row form-row-last">
                        <label for="senha">Senha <span class="required">*</span>
                        </label>
                        <input type="password" id="senha" placeholder="Digite a sua senha" name="password" class="input-text">
                    </p>
                    <div class="clear"></div>
